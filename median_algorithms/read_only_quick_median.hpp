...
#ifndef TMB_READ_ONLY_QUICK_MEDIAN_07_21_2015_HPP
#define TMB_READ_ONLY_QUICK_MEDIAN_07_21_2015_HPP
 ...
 * of two elements. For numerical data, consider using the alternate algorithm
...
#include "detail/read_only_quick_median_detail.hpp"
...
/**
 * Function read_only_quick_median
 * ===============================
 *
...
std::pair<Iterator, Iterator> read_only_quick_median(Iterator begin, Iterator end)
{
    ...
    return read_only_quick_median_detail::read_only_quick_median_internal(
        begin, end, read_only_quick_median_detail::standard_pivoting_strategy(begin, end), performance_stats);
}
 ...
 * no tendency to be sorted. If sorted data is likely, use read_only_quick_median
 * instead, regardless of the iterator category.
 */
template <typename Iterator>
std::pair<Iterator, Iterator> read_only_quick_median_random_data(Iterator begin, Iterator end)
{
    no_op_median_performance_stats performance_stats;
    return read_only_quick_median_detail::read_only_quick_median_internal(
        begin,
...
#endif // TMB_READ_ONLY_QUICK_MEDIAN_07_21_2015_HPP
